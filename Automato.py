import sys  
import datetime
from afd.Automatos import Automato
from afd.Determinizacao import Determinizacao
from ..afd.EpsilonTransicao import EpsilonTransicao
from ..afd.Inalcancaveis import Inalcancaveis
from ..afd.Mortos import Mortos
